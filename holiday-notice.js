/*
 * BH Locksmith Metro Detroit: temporary Sukkot 2026 closure notice.
 ...
 * hydration mismatch, and it stops showing at 2026-09-28 09:00 Eastern.
...
(function () {
  ...
  function build() {
    ...
    box.id = ID;
    box.setAttribute('aria-label', 'Sukkot holiday hours');
    box.style.cssText = [
    ...
    strong.textContent = 'Closed for Sukkot.';
