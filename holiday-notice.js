/*
 * BH Locksmith Metro Detroit: temporary Rosh Hashanah 2026 closure notice.
 ...
 * hydration mismatch, and it stops showing at 2026-09-14 09:00 Eastern.
...
(function () {
  ...
  var ARTICLE = '/blog/happy-rosh-hashanah-2026/';
  ...
  function build() {
    ...
    box.id = ID;
    box.setAttribute('aria-label', 'Rosh Hashanah holiday hours');
    box.style.cssText = [
    ...
    strong.textContent = 'Closed for Rosh Hashanah.';
